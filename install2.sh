...
[ -z "${CONTROL_ID}" ] && CONTROL_ID="control C-0270"  # Default control ID if not provided
...
if ! kubectl get nodes &> /dev/null; then
    echo -e "\033[0;37;32m\nRun:"
    echo -e "\033[1;35;40m$ $KUBESCAPE_EXEC scan $CONTROL_ID -v"
    echo
    exit 0
fi
...
$KUBESCAPE_EXEC scan $CONTROL_ID -v
